...
<head>
    ...
    <title>Laracamp Registered</title>
                                    ...
                                    <td align="center" height="70" style="height:70px;">
                                        <a href=""
                                            style="display: block; border-style: none !important; border: 0 !important;"><img
                                                width="300" border="0"
                                                style="display: block; width: 100px; width: 230px !important"
                                                src="{{ asset('images/logo@3x.svg') }}" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Hi <span style="color: #31B380;">{{ $user->name }}</span>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0"
                                bgcolor="31B380" style="border-radius: 99px">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="{{ route('login') }}"
                                                style="color: #ffffff; text-decoration: none;">Sign
                                                In</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <a href=""
                                            style="display: block; border-style: none !important; border: 0 !important;"><img
                                                width="200" border="0"
                                                style="display: block; width: 80px; width: 150px !important"
                                                src="{{ asset('images/logo@3x.svg') }}" alt="" /></a>
                                    </td>
                                </tr>
                                    ...
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            Email us: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@laracamp.id</a>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">laracamp.id</span>
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <a style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: #31B380; text-decoration: none;font-weight:bold;"
                                                        href="#">UNSUBSCRIBE</a>
                                                </td>
                                            </tr>
                                        </table>
